        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicNotes_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AcademicNotes_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicNotifications_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AcademicNotifications_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inquiries_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inquiries_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    FacultyResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingRequests_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficialExcuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficialExcuses_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OfficialExcuses_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestLogs_AspNetUsers_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacultyMemberId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_AspNetUsers_FacultyMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentMark = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    RequestReason = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    SubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReviewedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FacultyNote = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeReviewRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradeReviewRequests_AspNetUsers_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GradeReviewRequests_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GradeReviewRequests_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_AspNetUsers_FacultyMemberId",
                        column: x => x.FacultyMemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Announcements_AspNetUsers_TargetStudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Conversations_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnouncementRecipients_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicNotes_FacultyId",
                table: "AcademicNotes",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicNotes_StudentId",
                table: "AcademicNotes",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicNotifications_FacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_TargetStudentId",
                table: "Announcements",
                column: "TargetStudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_FacultyId",
                table: "Appointments",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_MeetingRequestId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_SectionId",
                table: "Conversations",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeReviewRequests_CourseId",
                table: "GradeReviewRequests",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeReviewRequests_FacultyId",
                table: "GradeReviewRequests",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeReviewRequests_ReferenceNumber",
                table: "GradeReviewRequests",
                column: "ReferenceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GradeReviewRequests_StudentId",
                table: "GradeReviewRequests",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Inquiries_FacultyId",
                table: "Inquiries",
                column: "FacultyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingRequests_FacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficialExcuses_FacultyId",
                table: "OfficialExcuses",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_OfficialExcuses_ReferenceNumber",
                table: "OfficialExcuses",
                column: "ReferenceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OfficialExcuses_StudentId",
                table: "OfficialExcuses",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_PerformedByUserId",
                table: "RequestLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_FacultyMemberId",
                table: "Sections",
                column: "FacultyMemberId");
